      ...
      <xsl:choose>
         <xsl:when test="//n1:regionOfInterest[@ID=$imageRef]">
            ...
            <xsl:if
               ...
               <xsl:element name="img">
                  <xsl:attribute name="src"><xsl:value-of select="//n1:regionOfInterest[@ID=$imageRef]//n1:observationMedia/n1:value/n1:reference/@value"/>
                  </xsl:attribute>
               </xsl:element>
            </xsl:if>
         </xsl:when>
         <xsl:otherwise>
            ...
            <xsl:if
               ...
               <br clear="all" />
               <xsl:element name="img">
                  <xsl:attribute name="src"><xsl:value-of select="//n1:observationMedia[@ID=$imageRef]/n1:value/n1:reference/@value" />
                  </xsl:attribute>
               </xsl:element>
            </xsl:if>
         </xsl:otherwise>
...
-->
   ...
   <xsl:template match="//n1:*[@styleCode]">
	  ...
	  <!-- Added by me -->
      <xsl:if
         test="not (contains(@styleCode,'Italics')) and not (contains(@styleCode,'Underline')) and not (contains(@styleCode, 'Bold'))">
            <xsl:apply-templates />
      </xsl:if>
